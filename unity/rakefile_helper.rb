...
module RakefileHelpers
  ...
  def get_local_include_dirs
    ...
    include_dirs.concat(get_unity_include_dirs)
    include_dirs.delete_if {|dir| dir.is_a?(Array)}
    return include_dirs
  end

  def get_unity_include_dirs
      return [UNITY_ROOT+'src/', UNITY_ROOT+'extras/fixture/src/']
  end
  ...
  def add_unity_include_dirs(includes)
      return includes + get_unity_include_dirs()
  end
  ...
  def build_compiler_fields
    ...
    include_dirs = add_unity_include_dirs($cfg['compiler']['includes']['items'])
    includes = squash($cfg['compiler']['includes']['prefix'], 
                      include_dirs)
