...
//******************************************************************************
// HEADER:  ComDebug.cpp
// PURPOSE: Contains utility functions for COM debugging.
// AUTHOR:  BHI  Jun 1996
//
#include "wincpp.hpp"
#include "ComDebug.h"
...
//           code expansion for the COM_IS_VALID_INTERFACE macro.
//
BOOL COM_IsValidInterface(LPUNKNOWN pInterface, LPCSTR pszInterface, LPCSTR pszFile, int nLine)
{
   BOOL bRval = FALSE;
   if (pInterface)
   {
...
BOOL COM_CheckHResult(HRESULT hResult, LPCSTR pszFile, int nLine)
{
   ...
   COM_ShowHResult(hResult, pszFile, nLine);
   return FALSE;
}
